...
import Grupo3A.dominio.User;        // Clase que representa la entidad de usuario en el dominio de la aplicación.
import Grupo3A.Utils.PasswordHasher; // Clase utilitaria para el manejo seguro de contraseñas (hash, verificación).
...
public class UserDAO {
     ...
     * @throws SQLException  ocurre un error al interactuar con la base de datos
    ...
    public User authenticate(User user) throws SQLException{
        ...
        try {
            ...
            if (rs.next()) {
                //  se encontró un usuario, asignar los valores de las columnas al objeto userAutenticate.
