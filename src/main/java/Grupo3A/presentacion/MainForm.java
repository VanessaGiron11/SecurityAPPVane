...
public class MainForm extends JFrame {
    ...
    public void setUserAutenticate(User userAutenticate) {
        ...
        private void createMenu() {
            ...
            JMenuItem itemEstudiantes = new JMenuItem("Estudiantes"); // Crea un nuevo elemento de menú llamado "Usuarios".
            menuMantenimiento.add(itemEstudiantes); // Agrega el elemento "Usuarios" al menú "Mantenimientos".
            itemEstudiantes.addActionListener(e -> { // Agrega un ActionListener al elemento "Usuarios".
                EstudianteReadingForm estudianteReadingForm = new EstudianteReadingForm(this); // Cuando se hace clic, crea una nueva instancia de UserReadingForm (formulario para leer/listar usuarios), pasándole la instancia actual de MainForm como padre.
                estudianteReadingForm.setVisible(true); // Hace visible el formulario de lectura de usuarios.
            });
        }
    }
