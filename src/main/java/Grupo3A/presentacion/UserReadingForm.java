...
public class UserReadingForm extends JDialog {
    ...
    private void hideCol(int pColumna) {
        ...
        this.tbUser.getColumnModel().getColumn(pColumna).setMaxWidth(0);
        ...
        this.tbUser.getColumnModel().getColumn(pColumna).setMinWidth(0);
        ...
        this.tbUser.getTableHeader().getColumnModel().getColumn(pColumna).setMaxWidth(0);
        this.tbUser.getTableHeader().getColumnModel().getColumn(pColumna).setMinWidth(0);
    }
    ...
    private User getUserFromTableRow() {
        ...
        try {
            ...
            int filaSelect = this.tbUser.getSelectedRow();
            ...
            if (filaSelect != -1) {
                ...
                id = (int) this.tbUser.getValueAt(filaSelect, 0);
            } else {
